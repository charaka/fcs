  <div class="box-body">
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <div class="input-group date">
            ...
            {!! Form::text('tanggal_publish', date('d/m/Y'), ['class' => 'form-control pull-right datepicker_input required', 'placeholder' => 'Tanggal Publish','id'=>'created_at','required'=>'required']) !!}
          </div>
        </div>
      </div>  
      <div class="col-md-8">
      ...
      <div class="col-md-4" style="margin-top: 10px">
        ...
        {!! Form::select('id_lokasi', ['' => 'Pilih Lokasi...']+$lokasi , $post->id_lokasi, ['class' => 'form-control select2','style'=>'width:100%']) !!}
      </div>
      <div class="col-md-12">
        <div class="form-group">
