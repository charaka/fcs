...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ url('home') }}" class="logo">
      ...
      <span class="logo-mini"><b>F</b>CS</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>WEB</b> DASHBOARD</span>
    </a>
                ...
                <ul class="menu" style="overflow: hidden; width: 100%; height: 200px;">
                  ...
                  <li id="">
                      ...
                      <label style="width: 100%; padding: 10px 10px 10px 38px;">
                        <input onclick="change_role({{ $value->role->id }})" name="role_active" value="{{ $value->role->id }}" data-name="{{ $value->role->role_title }}" data-mode_handle="1" type="radio" {{ (Session::get('user_role_active')==$value->role->id?"checked":"") }}>{{ $value->role->role_title }}
                      </label>
                      </div>
                      </a>
                  </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="#">DeWeb</a>.</strong> All rights
    reserved.
  </footer>
