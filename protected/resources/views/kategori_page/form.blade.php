...
<div class="row">
	<div class="col-xs-12">
		<div class="form-group">
			...
			{!! Form::text('kategori_in', $kategori_page->kategori_in, array('id' => 'kategori_in', 'class' => 'form-control', 'placeholder'=>'Kategori In','required'=>'required')) !!}
		</div>
	</div>
	<div class="col-xs-12">
		<div class="form-group">
	...
	<div class="col-xs-12">
		<div class="form-group">
	      <label>
            <input type="checkbox" id="is_menu" name="is_menu" value="1" {{ $kategori_page->is_menu==1?"checked":""}}> Is Menu
          </label>
		</div>
	</div>
	<div class="col-xs-12">
