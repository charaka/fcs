  ...
  <div class="box-body">
    <div class="row">
      <div class="col-md-12">
        ...
        <table class="table table-condensed table-bordered table-striped" id="tb_kategori_statistik" style="width: 100%"> 
          <thead>
            <tr>
              <th>No</th>
              <th>Kategori</th>
...
<script type="text/javascript">
  var tb_kategori_statistik = $('#tb_kategori_statistik').dataTable( {
    processing: true,
        serverSide: true,
        ajax: '{{ url("kategori_statistik/listing") }}',
        columns: [
  ...
  $('#tb_kategori_statistik_filter input').unbind();
  $('#tb_kategori_statistik_filter input').bind('keyup', function(e) {
    if(e.keyCode == 13) {
      tb_kategori_statistik.fnFilter(this.value);
    }
  })

  function show_form(id = ""){
    if(id == ""){
      url_form = '{{url("kategori_statistik/create")}}';
      title_form = 'Tambah Data';
    } else {
      url_form = '{{url("kategori_statistik/")}}/'+id+'/edit';
                  ...
                  $.ajax({
                      ...
                      success:function(data){
                              if(data.submit=='1'){
                                ...
                                location.href = "{{ url('kategori_statistik') }}";
                              }else{
                                $.alert({
                                  title: 'Hapus Data',
                                  type : 'red',
