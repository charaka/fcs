...
<div class="form-group">
  ...
  {!! Form::select('model', ['' => 'Model','kategori'=>'Kategori Post','kat_pages'=>'Kategori Page','post'=>'Post','pages'=>'Pages','galeri'=>'Galeri','lokasis'=>'Lokasi'] , $menu->model, ['class' => 'form-control select2','style'=>'width:100%','id'=>'model']) !!}
</div> 
<div class="form-group">
