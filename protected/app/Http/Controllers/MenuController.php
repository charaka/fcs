...
class MenuController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        }else if($model=="kat_pages"){
          $getSlug = kategori_page::where('id','=',$posting)->select('slug_in','slug_en')->first();
        }else if($model=="galeri"){
            $getSlug = galeri::where('id','=',$posting)->select('slug_in','slug_en')->first();
        }else if($model=="lokasis"){
            $getSlug = lokasi::where('id','=',$posting)->select('slug_in','slug_en')->first();
        }else{
    ...
    public function getModel(Request $request){
        ...
        if(!empty($id)){
            if($id=="kategori"){
            ...
            }else if($id=="kat_pages"){
                $subHeaders = kategori_page::select('kategori_in','id')->get();
                $select = "";
                $select .= "<option value=''>Pilih...</option>";
                foreach ($subHeaders as $key => $value) {
                    $select .="<option value=".$value->id.">".$value->kategori_in."</option>";
                ...
                $subHeaders = lokasi::select('lokasi','id')->get();
                $select = "";
                $select .= "<option value=''>Pilih...</option>";
                foreach ($subHeaders as $key => $value) {
                    $select .="<option value=".$value->id.">".$value->lokasi."</option>";
                }
            }
        }else{
            $select = "";
